...
model = vvf_turnazione.TurnazioneVVF(data_inizio, data_fine, squadra_di_partenza, giorni_festivi_speciali, vigili_fn, riporti_fn, loose=loose, compute_aspiranti=compute_aspiranti, no_servizi_compleanno=no_servizi_compleanno)
